...
void sub_goal_callback(const std_msgs::Float64MultiArray &msg) {
	g_x1 = (msg.data[goal_num]/20)-9.9;
	g_y1 = (msg.data[goal_num+1]/20)-21.1;
	g_x2 = (msg.data[goal_num+2]/20)-9.9;
	g_y2 = (msg.data[goal_num+3]/20)-21.1;
	g_x = g_x1;
	g_y = g_y1;
...
int main(int argc, char **argv){
        ros::init(argc, argv, "control_lab6");
        ros::NodeHandle nh;
